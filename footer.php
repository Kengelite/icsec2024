<!-- FOOTER -->
<footer style="background-color: #032738; " class="mt-5">
    <div class="footer-top">
        <div class="container">
            <div class="row gy-5">
                <div class="col-lg-4 col-sm-6">
                    <a class="navbar-brand" href="./index.html">
                        <img src="./assets/images/logo2024.png" width="160" alt="">
                    </a>
                    <div class="line"></div>
                    ...
                    <div class="social-icons">
                        <a href="https://www.facebook.com/computing.kku"><i class="ri-facebook-fill" style="color: white;"></i></a>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="line"></div>
                    <ul>
                        <li> September 13, 2024 2:25 PM</li>
                    </ul>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <ul>
                        <li>
                            <div style="cursor: pointer;color: white;" data-bs-toggle="modal" data-bs-target="#showcallforsupportus">Support Us</div>
                        </li>
                        <li>
                            <div style="cursor: pointer;color: white;" data-bs-toggle="modal" data-bs-target="#showcallforSponsorship">Sponsorship Form</div>
                        </li>
                    </ul>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row g-4 justify-content-center">
                <div class="col-auto">
                    <p class="mb-0">© Copyright by <a href="https://computing.kku.ac.th/">College
...
<div class="modal fade" id="showcallforsupportus" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="showcallforsupportus" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="./assets/images/sponsorus.jpg" alt="Support Us" id="supportUsImage">
            </div>
            <div class="modal-footer">
                <a type="button" class="btn btn-primary" target="_blank" href="./assets/images/sponsorus.jpg" download="sponsorus.jpg" style="color: white;">Download</a>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="showcallforpaper" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="showcallforpaper" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Call for Papers</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
