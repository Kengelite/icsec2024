        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="about-text" style="text-align: justify;">
                          Phra Mahathat Kaen Nakhon or Phra That Kao Chan is a reinforced concrete building made of
                        brick and
                        cement. It has a pagoda-shaped top. At the top of the pagoda you can see views of Bueng Kaen
                        Nakhon
                        ...
                        Mixing Indochina arts Inside the Phra That there are 9 floors. And inside the floor will be
                        covered
                        with marble.
                        <br>
                          Tourists can visit inside. Phra Mahathat Kaen Nakhon has a total of 9 floors, with every floor
                        having different beauty and interest. The top floor will house the Buddha's relics. For example,
                        the
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="about-text" style="text-align: justify;">
                          Wat Phra Phutthabat Phu Phan Kham It is a temple located on the top of Phu Phan Kham Mountain.
                        To go
                        up to worship Luang Pho Khao which is enshrined on the top of Phu Phan Kham mountain. You have
                        to
                        walk up 1049 steps. It is a test of your willpower, faith, and determination in conquering the
                        Phuphan Kham Mountain. At the entrance to the stairs is a 7-headed Nagarat statue with a pipe
                        all
                        the way to the top. Along the path there are lush green trees.
                        <br>
                          Wat Phra Phutthabat Phu Phan Kham It is one of the temples located on a mountain that has one
                        of the
                        ...
                        monks rested in admiration. People flock to worship and pray for blessings and prosperity in
                        life.
                        There are not many. In the area below Luang Por Khao, there are still places of worship. Let's
                        make
                        a wish too.
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="about-text" style="text-align: justify;">
                          Check out this cool new shopping spot in Khon Kaen! It's all about creating a chill vibe,
                        perfect
                        for those post-work evenings. Imagine a place where art lovers, collectors, and inventors can
                        hang
                        out and showcase their stuff. They've got storytelling sessions, drama performances, dance
                        shows,
                        photography exhibits, and even street performances. It's not just about shopping; it's a cool
                        space
                        for people with similar interests to connect. Classic car and big bike crews often drop by to
                        flaunt
                        their wheels and swap ideas. If you're into a laid-back shopping scene and good vibes, this is
                        the
                        spot for you!
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div id="myCarousel2" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        <div class="carousel-inner" data-bs-interval="50">
                            <div class="carousel-item active">
                                <img src="./assets/images/PraMahathatKaenNakhon5.jpg" class="d-block " alt="...">
                            </div>
                        </div>
                        <button class="carousel-control-prev" type="button" data-bs-target="#myCarousel2"
                            data-bs-slide="prev">
                ...
                <div class="col-lg-6">
                    <!-- ข้อความข้างๆรูปภาพ -->
                    <h2 class="about-text">The Ministry of Culture invites you to attend the Royal Kathin Festival
                        celebration organized by the Ministry of Culture for the year 2024.</h2>
                    <p class="about-text" style="text-align: justify;">
                        Date: Friday, November 8, 2024 <br>
                        Location: Wat Nong Waeng, Royal Monastery, Nai Mueang Subdistrict, Mueang Khon Kaen District,
                        Khon Kaen Province <br>
                        Time: Starting from 5:00 PM onward
                        <br>
                        Join the Buddhist chanting ceremony in celebration of the Royal Kathin Festival and enjoy:
                    <ul>
                        <li>Khon dance drama from the Ramayana, featuring scenes of “Phiphek Swamiphak,” the battle with
                            Kumbhakarna (Rang Withdrawal), and the battle with Ravana, presented by the Fine Arts
                            Department's Office of Performing Arts</li>
                        <li>
                            Honorary dance performance by the Khon Kaen Provincial Cultural Council
                        </li>
                        <li>Modern-style Mor lam folk singing by National Artist Ratree Sriwilai, specializing in the
                            performing arts</li>
                        <li>Traditional Mor lam folk singing by local artist Jintana Yensawat</li>
                    </ul>
